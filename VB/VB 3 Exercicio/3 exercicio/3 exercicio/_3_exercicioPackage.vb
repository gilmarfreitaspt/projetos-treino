...
<Guid(_3_exercicioPackage.PackageGuidString)>
Public NotInheritable Class _3_exercicioPackage
    Inherits AsyncPackage

    ''' <summary>
    ''' Package guid
    ''' </summary>
    Public Const PackageGuidString As String = "4bf036be-312d-4a76-a0dc-9155dcfa2e26"
